...
public class Main_v3 {
    ...
    private static List<Home_v2> filter(List<Home_v2> homesList, HomeFilter... homeFilters) {
    ...
    public static void main(String[] args) {
        ...
        List<Home_v2> filteredList = filter(homesList, new HomeFilter() {

            @Override
            public boolean test(Home_v2 home) {
